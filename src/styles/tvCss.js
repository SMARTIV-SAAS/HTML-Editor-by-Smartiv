...
.sv-tv {
  margin: 0;
  min-height: 100vh;
  /* Transparent unless a host opts in via --sv-bg. The background is an editing
     aid — it makes a white font visible while authoring — and the player
     composes its own wallpaper behind the WebView, so the document must not
     paint over it. */
